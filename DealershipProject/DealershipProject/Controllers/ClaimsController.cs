...
namespace DealershipProject.Controllers
{
    public class ClaimsController : Controller
    {
        private readonly DealershipContext _context;

        public ClaimsController(DealershipContext context)
        {
            _context = context;
        }
        ...
        {
            var dealershipContext = _context.Claims.Include(c => c.Vehicle);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Description,Status,Date,VehicleId")] Claim claim)
        {
            if (id != claim.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'DealershipContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
